...
assert(gameIndex.includes('js/locale-terrain-placement.js?v=20260924localecollider1'), 'the actual game page must load terrain-aware locale placement after the wilderness generator');
