...
assert.doesNotMatch(handSource, /solveTwoBoneArm/, 'direct hand runtime must contain no arm IK');
assert.doesNotMatch(handSource, /shoulder/i, 'direct hand runtime must not depend on shoulder solving');
