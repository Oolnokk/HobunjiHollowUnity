...
assert.match(source, /function _tickCompanionWatchIdle\([\s\S]{0,500}c\.vx = 0; c\.vy = 0;[\s\S]{0,240}Math\.atan2\(dy, dx\)/, 'watch-player stops and faces the player while its timer runs');
