...
(async () => {
  ...
  assert.deepEqual(captured.cfg.weaponShapePool, ['daggerSword', 'fishingspear', 'hatchet']);
  assert.deepEqual(captured.cfg.rangedWeaponChanceByRank, { grunt: 0, lieutenant: 0, captain: 0 });
