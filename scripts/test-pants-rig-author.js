...
const portraitBootstrapSource = read('docs/tools/pants-rig-author/portrait-runtime-bootstrap.js');
...
assert.match(appLoaderSource, /portrait-runtime-bootstrap\.js/);
assert.match(appLoaderSource, /PantsRigPortraitBootstrap\?\.ready/);
assert.ok(appLoaderSource.indexOf('portrait-runtime-bootstrap.js') < appLoaderSource.indexOf('app-base.js'), 'portrait runtime must initialize before app-base boots');
...
assert.match(portraitBootstrapSource, /ensurePortraitCosmetics/);
assert.match(portraitBootstrapSource, /loadPortraitCosmetics/);
assert.match(portraitBootstrapSource, /\.\.\/\.\.\/config\//);
assert.match(portraitBootstrapSource, /\.\.\/\.\.\/assets\//);
assert.match(portraitBootstrapSource, /getPortraitFighters/);
assert.match(portraitBootstrapSource, /fighterKeys/);
