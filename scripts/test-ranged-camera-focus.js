...
assert.match(loader, /ranged-camera-focus\.js\?v=20260918throwfocus2[\s\S]*HobunjiRangedCameraFocus\?\.version\) >= 9/, 'loader requires smooth native-offset ranged focus v9');
