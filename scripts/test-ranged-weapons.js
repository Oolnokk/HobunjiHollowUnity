...
assert.match(index, /scratchbones-config\.js\?v=20260901input2/, 'game bootstrap must invalidate the mobile-safe ranged/audio/input config cache');
assert.match(index, /game\.js\?v=20260901input2/, 'game bootstrap must invalidate the ranged loadout/input wiring cache');
