...
const banubuLocale = JSON.parse(fs.readFileSync('docs/config/locales/locale_banubu_cave_interior.json', 'utf8')); // Authoritative main-cave material selection.
const colorPoolsLocale = JSON.parse(fs.readFileSync('docs/config/locales/locale_color_pools_cave.json', 'utf8')); // Hidden room must intentionally share Banubu's textured farm-cliff shell path.
...
assert.equal(colorPoolsLocale.cavern.surfaceMaterial, 'farm-cliff', 'Banubu Color Pools use the same textured farm-cliff carved-shell path');
