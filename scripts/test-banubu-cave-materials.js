...
const colorPoolsLocale = JSON.parse(fs.readFileSync('docs/config/locales/locale_color_pools_cave.json', 'utf8')); // Hidden room intentionally shares Banubu's textured farm-cliff shell path.
...
assert.equal(colorPoolsLocale.cavern.surfaceMaterial, 'farm-cliff', 'Color Pools opts into the same textured farm-cliff carved-shell path');
