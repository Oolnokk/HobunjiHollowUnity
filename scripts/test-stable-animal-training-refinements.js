...
assert.match(troughSource, /livestock-nursery-install-bridge\.js\?v=20260916stable5/, 'farm trough bootstrap cache-busts the current feature bridge');
...
assert.match(formatUtilsSource, /livestock-nursery-install-bridge\.js\?v=20260916stable5/, 'direct pre-game Stable loader uses the current bridge cache key');
