...
assert.match(troughSource, /livestock-nursery-install-bridge\.js\?v=20260920startup1/, 'farm trough bootstrap cache-busts the current feature bridge');
...
assert.match(formatUtilsSource, /livestock-nursery-install-bridge\.js\?v=20260920startup1/, 'direct pre-game Stable loader uses the current bridge cache key');
