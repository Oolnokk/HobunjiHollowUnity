...
assert.match(gameIndexSource, /held-action-animations\.js\?v=20260925dialogue1/, 'Game entry point must refresh the held-action bootstrap that owns the shared grip helper URL.');
assert.match(attackEditorSource, /held-action-animations\.js\?v=20260924perf1/, 'Attack Editor entry point must refresh the same held-action bootstrap before rendering throw spin.');
