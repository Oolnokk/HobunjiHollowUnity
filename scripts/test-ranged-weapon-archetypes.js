...
assert.match(gameIndexSource, /held-action-animations\.js\?v=20260925shouldercamonly1/, 'Game entry point must refresh the held-action bootstrap that owns the shared grip helper URL.');
assert.match(attackEditorSource, /held-action-animations\.js\?v=20260925shouldercamonly1/, 'Attack Editor entry point must refresh the same held-action bootstrap before rendering throw spin.');
