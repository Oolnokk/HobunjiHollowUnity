...
assert.match(attackEditorSource, /<script src="\.\.\/\.\.\/js\/hand-tool-grips\.js\?v=[^"]+"><\/script>[\s\S]*<script type="module">/, 'Attack Editor must load the shared hand-tool-grips runtime before its module so pivot compensation cannot silently no-op.');
