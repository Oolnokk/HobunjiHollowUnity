...
assert.match(gameIndexSource, /held-action-animations\.js\?v=20260924perf1/, 'Game entry point must refresh the held-action bootstrap that owns the shared grip helper URL.');
