...
assert.match(loaderSource, /livestock-harvest-staging\.js\?v=20260918harvestanim1/, 'the shared interaction loader includes the harvest staging bridge before gameplay boots');
