...
(() => {
  ...
  const VERSION = 5; // Latest user-authored Full Character Scale export, 2026-09-05.
  const VALUES = Object.freeze({
    'tletingan::male': Object.freeze({ x: 0.85, y: 0.85, head: 0.8824, offsetY: 0 }),
    'tletingan::female': Object.freeze({ x: 0.915, y: 0.89, head: 0.8471, offsetY: 0 }),
    'engh-sho::male': Object.freeze({ x: 0.8, y: 0.845, head: 0.9053, offsetY: 0 }),
    'engh-sho::female': Object.freeze({ x: 0.795, y: 0.81, head: 0.8947, offsetY: 0 }),
    'mao-ao::male': Object.freeze({ x: 1.125, y: 1.125, head: 1.0813, offsetY: 0 }),
    'mao-ao::female': Object.freeze({ x: 1.045, y: 1.045, head: 1.075, offsetY: 0 }),
    'kenkari::male': Object.freeze({ x: 1.225, y: 1.225, head: 1.04, offsetY: 0 }),
    'kenkari::female': Object.freeze({ x: 1.1, y: 1.1, head: 1.0467, offsetY: 0 }),
