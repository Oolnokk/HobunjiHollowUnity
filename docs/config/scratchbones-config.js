window.SCRATCHBONES_CONFIG = {
  ...
  game: {
    ...
    "input": {
      "storageKey": "scratchbones.inputBindings.v2",
      "legacyStorageKeys": ["scratchbones.inputBindings.v1"],
      "bindingSlotsPerAction": 2,
      "gamepadDeadzone": 0.24,
      "axisPressThreshold": 0.55,
      "desktopConfirmInput": "Enter",
      "controllerTriggerInputs": [{ "buttonIndex": 6, "code": "LeftTrigger" }, { "buttonIndex": 7, "code": "RightTrigger" }],
      "controllerAxisInputs": { "left": "RightStickLeft", "right": "RightStickRight", "up": "RightStickUp", "down": "RightStickDown" },
      "meleeAutoTargetOverrideInput": "Button11",
      "newModeShiftDefaults": { "label": "Custom Shift", "device": "controller", "button": "Button4" },
      "controllerInputOptions": ["Button0", "Button1", "Button2", "Button3", "Button4", "Button5", "LeftTrigger", "RightTrigger", "Button8", "Button9", "Button10", "Button11", "Button12", "Button13", "Button14", "Button15", "RightStickLeft", "RightStickRight", "RightStickUp", "RightStickDown"],
      "inputLabels": { "Mouse0": "Mouse Left", "Mouse1": "Mouse Middle", "Mouse2": "Mouse Right", "Mouse3": "Mouse Back", "Mouse4": "Mouse Forward", "LeftTrigger": "LT", "RightTrigger": "RT", "RightStickLeft": "RS ←", "RightStickRight": "RS →", "RightStickUp": "RS ↑", "RightStickDown": "RS ↓", "WheelUp": "Wheel ↑", "WheelDown": "Wheel ↓" },
      "targeting": {
        "orbitRadiusTiles": 0.62,
        "inputAimDeadzone": 0.08
      },
      "actions": [
        { "id": "moveUp", "label": "Move Up / Forward", "desktop": ["KeyW", "ArrowUp"], "controller": [null, null] },
        { "id": "moveDown", "label": "Move Down / Back", "desktop": ["KeyS", "ArrowDown"], "controller": [null, null] },
        { "id": "moveLeft", "label": "Move Left", "desktop": ["KeyA", "ArrowLeft"], "controller": [null, null] },
        { "id": "moveRight", "label": "Move Right", "desktop": ["KeyD", "ArrowRight"], "controller": [null, null] },
        { "id": "menuToggle", "label": "Open / Close Menu", "desktop": ["Escape", "Tab"], "controller": [null, null] },
        { "id": "mapToggle", "label": "Open / Close Map", "desktop": ["KeyM", null], "controller": [null, null] },
        { "id": "putAway", "label": "Put Away Held Equipment", "desktop": ["KeyZ", null], "controller": [null, null] },
        { "id": "cameraOrbitModifier", "label": "Camera Orbit / Auto-Target Toggle", "desktop": ["ShiftLeft", "ShiftRight"], "controller": [null, null] },
        { "id": "debugLegBones", "label": "Debug: Leg Bones", "desktop": ["KeyB", null], "controller": [null, null] },
        { "id": "interact", "label": "Interact", "desktop": ["KeyE", null], "controller": ["Button0", null] },
        { "id": "dodge", "label": "Dodge", "desktop": ["KeyX", null], "controller": ["Button1", null] },
        { "id": "action1", "label": "Tool/Item Action 1", "desktop": ["Mouse0", "Space"], "controller": ["RightTrigger", null], "legacyDesktopBinding": "Space" },
        { "id": "action2", "label": "Tool/Item Action 2", "desktop": ["Mouse2", null], "controller": ["LeftTrigger", null], "legacyDesktopBinding": "KeyQ" },
        { "id": "action3", "label": "Tool/Item Action 3", "desktop": ["KeyR", null], "controller": ["Button2", null] },
        { "id": "action4", "label": "Tool/Item Action 4", "desktop": ["Enter", null], "controller": ["Button3", null] },
        { "id": "action5", "label": "Tool/Item Action 5", "desktop": ["Digit7", null], "controller": ["Button12", null] },
        { "id": "action6", "label": "Tool/Item Action 6", "desktop": ["Digit8", null], "controller": ["Button9", null] },
        { "id": "action7", "label": "Tool/Item Action 7", "desktop": ["Digit9", null], "controller": ["Button14", null] },
        { "id": "action8", "label": "Tool/Item Action 8", "desktop": ["Digit0", null], "controller": ["Button15", null] },
        { "id": "swapTarget", "label": "Swap Target", "desktop": ["KeyG", null], "controller": ["Button5", null] },
        { "id": "meleeTargetPrev", "label": "Melee Auto-Target: Previous", "desktop": [null, null], "controller": ["RightStickLeft", null] },
        { "id": "meleeTargetNext", "label": "Melee Auto-Target: Next", "desktop": [null, null], "controller": ["RightStickRight", null] },
        { "id": "toggleMount", "label": "Call/Dismiss Mount", "desktop": ["KeyV", null], "controller": ["Button13", null] },
        { "id": "weaponSwitch", "label": "Swap Melee / Ranged", "desktop": ["Digit3", null], "controller": ["Button11", null] },
        { "id": "toolSelect", "label": "Tool Select", "desktop": ["KeyT", null], "controller": ["Button10", null] },
        { "id": "itemSelect", "label": "Item Select", "desktop": ["KeyQ", null], "controller": [null, null] },
        { "id": "utilitySelect", "label": "Utility Select", "desktop": ["KeyC", null], "controller": [null, null] },
        { "id": "itemPrev", "label": "Previous Item", "desktop": ["Comma", null], "controller": [null, null] },
        { "id": "itemNext", "label": "Next Item", "desktop": ["Period", null], "controller": [null, null] },
        { "id": "toolPrev", "label": "Previous Tool", "desktop": ["BracketLeft", null], "controller": [null, null] },
        { "id": "toolNext", "label": "Next Tool", "desktop": ["BracketRight", null], "controller": [null, null] },
        { "id": "tool1", "label": "Tool 1: Shovel", "desktop": ["Digit1", null], "controller": [null, null] },
        { "id": "tool2", "label": "Tool 2: Hoe", "desktop": ["Digit2", null], "controller": [null, null] },
        { "id": "tool4", "label": "Tool 4: Axe", "desktop": ["Digit4", null], "controller": [null, null] },
        { "id": "tool5", "label": "Tool 5: Pick", "desktop": ["Digit5", null], "controller": [null, null] },
        { "id": "tool6", "label": "Tool 6: Harpoon", "desktop": ["Digit6", null], "controller": [null, null] }
      ],
      "modeShifts": [
    ...
    "cssRootVars": {
      ...
      "--layout-cinematic-tankan-font-size": "clamp(1.4rem, 3vw, 3.2rem)",
      "--layout-cinematic-tankan-letter-spacing": "0.08em",
      "--layout-cinematic-tankan-color": "var(--accent-2)",
      "--layout-cinematic-tankan-text-shadow": "0 2px 8px rgba(0,0,0,0.72)",
      "--layout-cinematic-tankan-initial-opacity": "0",
      "--layout-cinematic-tankan-opacity": "0.92",
      "--layout-cinematic-tankan-animation": "cinTankanRise 260ms ease-out both",
      "--layout-cinematic-tankan-rise-offset": "12px",
      "--layout-cinematic-tankan-z-index": "10012",
    ...
    "uiText": {
      ...
      "tableLocation": "Injimi's Underclub"
    },
    ...
    "uiWobblyOutlines": {
      ...
      "styleRules": [
        ...
        { "selector": ".chatLogBody", "style": { "lineWidth": 4.2, "step": 16, "wobble": 1, "seed": 79, "outset": 2 } },
    ...
    "assets": {
      ...
      "audio": {
        ...
        "voice": {
          ...
          "utterances": {
            "mao-ao": {
              "basePath": "./docs/assets/audio/sfx/voice/utterances/mao-ao/",
              "prefix": "mv01_",
              "volume": 0.9,
              "laugh": "laugh.ogg",
              "cuss": "cuss.ogg",
              "ntalk": ["ntalk1.ogg", "ntalk2.ogg", "ntalk3.ogg", "ntalk4.ogg"],
              "htalk": ["htalk1.ogg", "htalk2.ogg", "htalk3.ogg", "htalk4.ogg"],
              "atalk": ["atalk1.ogg", "atalk2.ogg", "atalk3.ogg", "atalk4.ogg"]
            },
            "kenkari": {
              "basePath": "./docs/assets/audio/sfx/voice/utterances/kenkari/",
              "prefix": "kv01_",
              "volume": 0.9,
              "laugh": "laugh.ogg",
              "cuss": "cuss.ogg",
            ...
            "rakakoan": {
              "basePath": "./docs/assets/audio/sfx/voice/utterances/rakakoan/",
              "prefix": "rv01_",
              "volume": 0.9,
              "laugh": "laugh.ogg",
              "cuss": "cuss.ogg",
            ...
            "tletingan": {
              "basePath": "./docs/assets/audio/sfx/voice/utterances/tletingan/",
              "prefix": "tv01_",
              "volume": 0.9,
              "laugh": "laugh.ogg",
              "cuss": "cuss.ogg",
            ...
            "engh-sho": {
              "basePath": "./docs/assets/audio/sfx/voice/utterances/engh-sho/",
              "prefix": "ev01_",
              "volume": 0.9,
              "laugh": "laugh.ogg",
              "cuss": "cuss.ogg",
    ...
    "npcPools": {
      "kumapirran-citizens": {
        "label": "Kumapirran Citizens"
      },
      "riverlands-bandits": {
        "label": "Riverlands Bandits",
        "speciesRestriction": ["mao-ao"],
        "genderWeights": { "male": 9, "female": 1 },
        "nicknames": [
          "Scratcher", "Fang", "Claw", "Prowl", "Slink", "Hiss", "Snarl", "Pounce", "Bristle",
          "Grim", "Dagger", "Thorn", "Lash", "Snap", "Rend", "Gash", "Notch", "Crook", "Hook",
          "Squall", "Murk", "Bog", "Muck", "Slick", "Drench",
          "Mudpaw", "Mudfoot", "Longtail", "Redtail", "Shorttail",
          "Two-Fingers", "Flatnose",
          "Bronze Claw", "Bronze Fang", "Bronze Tooth",
          "Bonecutter", "Gutripper", "Riverrat", "Mangrove", "Deadwood"
        ],
        "hoodImpliesTorso": "tankan_bodywrap",
        "cosmeticOverrides": {
          "M": {
            "weights": {
              "hat":        { "basic_headband": 55, "leather_headband": 25, "none": 15, "riverlandskasa_low": 3, "riverlandskasa_wide": 2 },
              "hood":       { "fine_hood": 25, "none": 75 },
              "torso":      { "bandolier1": 70, "none": 30 },
              "facialHair": { "wildbeard": 85, "none": 15 },
              "hairSide":   { "shoulder_length_drape": 30, "braid-R": 35, "braidcluster-R": 35, "none": 0 },
              "hairSideL":  { "braid-L": 90, "none": 10 }
            }
          },
          "F": {
            "weights": {
              ...
              "hood":      { "fine_hood": 25, "none": 75 },
              "torso":     { "bandolier1": 70, "none": 30 },
              "hairSide":  { "shoulder_length_drape": 30, "braid-R": 40, "braidcluster-R": 30, "none": 0 },
              "hairSideL": { "braid-L": 90, "none": 10 }
            }
          }
        },
        "clothingColorOverride": {
          "syncAcrossPieces": false,
          "range": {
            "choices": [
              { "weight": 4, "range": { "minH": -30, "maxH": 30, "stops": [
                { "h": -30, "sMin": 0.05, "sMax": 0.30, "vMin": 0.18, "vMax": 0.45 },
                { "h": 30,  "sMin": 0.05, "sMax": 0.30, "vMin": 0.18, "vMax": 0.45 }
              ]}},
              { "weight": 3, "range": { "minH": -90, "maxH": -30, "stops": [
                { "h": -90, "sMin": 0.04, "sMax": 0.25, "vMin": 0.15, "vMax": 0.42 },
                { "h": -30, "sMin": 0.04, "sMax": 0.25, "vMin": 0.15, "vMax": 0.42 }
              ]}},
              { "weight": 2, "range": { "minH": 30, "maxH": 80, "stops": [
                { "h": 30, "sMin": 0.03, "sMax": 0.18, "vMin": 0.20, "vMax": 0.48 },
                { "h": 80, "sMin": 0.03, "sMax": 0.18, "vMin": 0.20, "vMax": 0.48 }
              ]}},
              { "weight": 1, "range": { "minH": -180, "maxH": -90, "stops": [
                { "h": -180, "sMin": 0.03, "sMax": 0.20, "vMin": 0.15, "vMax": 0.40 },
                { "h": -90,  "sMin": 0.03, "sMax": 0.20, "vMin": 0.15, "vMax": 0.40 }
              ]}}
            ]
          }
        }
    ...
    "tables": [
      {
        "id": "riverlands-bandit-camp",
        "name": "Riverlands Bandit Camp",
        "tableLocation": "Riverlands Bandit Camp",
        "npcPoolId": "riverlands-bandits",
        "background": {
          "tabletopImageSrc": "./docs/assets/hud/tabletop.png"
        },
        "candlelight": {
        ...
        "waterEffect": {
          "enabled": true,
          "grooveCoupling": 0.62,
          "grooveSensitivity": 0.00,
          "highPointFlow": 1.0,
          "highPointSensitivity": 0.55
        },
        "outdoor": {
          "cycleDurationMs": 480000,
          "phases": [
            { "t": 0.00, "name": "predawn",       "skyRgb": [8,   12,  28 ], "skyOpacity": 0.58, "rainIntensity": 0.00 },
            { "t": 0.10, "name": "dawn",          "skyRgb": [200, 100, 50 ], "skyOpacity": 0.15, "rainIntensity": 0.00 },
            { "t": 0.18, "name": "morningburst",  "skyRgb": [210, 220,205 ], "skyOpacity": 0.13, "rainIntensity": 0.80 },
            { "t": 0.30, "name": "clearbreak",    "skyRgb": [255, 225,140 ], "skyOpacity": 0.22, "rainIntensity": 0.05 },
            { "t": 0.40, "name": "midday",        "skyRgb": [255, 218,110 ], "skyOpacity": 0.28, "rainIntensity": 1.00 },
            { "t": 0.58, "name": "afternoonbreak","skyRgb": [255, 222,135 ], "skyOpacity": 0.20, "rainIntensity": 0.08 },
            { "t": 0.66, "name": "duskstorm",     "skyRgb": [225, 170,100 ], "skyOpacity": 0.18, "rainIntensity": 0.85 },
            { "t": 0.78, "name": "twilight",      "skyRgb": [70,  30, 110 ], "skyOpacity": 0.42, "rainIntensity": 0.15 },
            { "t": 0.90, "name": "night",         "skyRgb": [5,   12,  25 ], "skyOpacity": 0.60, "rainIntensity": 0.00 }
          ],
          "rain": { "maxDrops": 160, "angleRad": 0.18 },
          "lightning": { "avgIntervalMs": 22000, "onlyPhases": ["morningburst", "midday", "duskstorm"] }
        },
        "bgm": {
          "playlist": [
            "./docs/assets/audio/bgm/tankan_nocturne.mp3"
      ...
      {
        "id": "injimis-underclub",
        "name": "Injimi's Underclub",
        "tableLocation": "Injimi's Underclub",
        "npcPoolId": "kumapirran-citizens",
        "unlockRequirement": "rotfang",
        "background": {
          "tabletopImageSrc": "./docs/assets/hud/tabletop.png"
        },
        "candlelight": {
          "radiusRefPx": 1200,
          "sources": [
            { "xPct": 0.0317708333, "yPct": 0.3333333333, "intensity": 0.77, "radiusMultiplier": 1, "flickerSpeed": 4.17, "turbulence": 1 },
            { "xPct": 1.18,         "yPct": 0.3333333333, "intensity": 0.77, "radiusMultiplier": 1, "flickerSpeed": 4.17, "turbulence": 1 }
          ],
          "backlitAlphaDefault": 0.14,
          "thevmenuOpacity": 0.35,
          "backlitBlurDefault": 0
    ...
    "activeTableId": "riverlands-bandit-camp"
  }
};
