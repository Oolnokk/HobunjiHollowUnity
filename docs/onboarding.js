...
(() => {
  ...
  const mashtzarrFemaleUrl = new URL('js/onboarding-character-creation-mashtzarr-female.js?v=20260907charcreator20', selfUrl).href; // Keeps female Mashtzarr on the male visual fallback while retaining hair controls and excluding facial hair.
