...
(() => {
  ...
  const weaponPolishUrl = new URL('js/onboarding-character-creation-weapon-polish.js?v=20260907charcreator8', selfUrl).href; // Normalizes Kenkari held-tool size and restores Hatchet/Spear idle sprite bases to the correct Hoe/Pick-Shovel equivalents.
  document.write(`<script src="${coreUrl}"><\/script><script src="${mashtzarrFemaleUrl}"><\/script><script src="${redesignUrl}"><\/script><script src="${lifePreviewUrl}"><\/script><script src="${weaponViewFixUrl}"><\/script><script src="${weaponPolishUrl}"><\/script>`);
})();
