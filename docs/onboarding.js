...
(() => {
  ...
  const mashtzarrFemaleUrl = new URL('js/onboarding-character-creation-mashtzarr-female.js?v=20260907charcreator19', selfUrl).href; // Makes female Mashtzarr inherit the exact male creator slot data (including hair selectors) and male portrait fighter as a temporary fallback.
  ...
  const cameraCompositionUrl = new URL('js/onboarding-character-creation-camera-composition.js?v=20260907charcreator18', selfUrl).href; // Presents the default character +10° off-center and keeps the preview camera at a level Mao'ao-male mid-body eye line.
