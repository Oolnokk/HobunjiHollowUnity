...
(() => {
  ...
  const mashtzarrFemaleUrl = new URL('js/onboarding-character-creation-mashtzarr-female.js?v=20260907charcreator12', selfUrl).href; // Enables the authored female Mashtzarr profile and shares Nashka Khibu's runtime-resolved hairstyle group with it.
  ...
  const cameraCompositionUrl = new URL('js/onboarding-character-creation-camera-composition.js?v=20260907charcreator13', selfUrl).href; // Presents the default character +15° off-center and keeps the preview camera at a level Mao'ao-male mid-body eye line.
