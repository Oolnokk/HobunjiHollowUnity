...
(() => {
  ...
  const mashtzarrFemaleUrl = new URL('js/onboarding-character-creation-mashtzarr-female.js?v=20260907charcreator17', selfUrl).href; // Keeps female Mashtzarr selectable/saved as female while temporarily reusing the known-good male Mashtzarr creator/portrait data.
