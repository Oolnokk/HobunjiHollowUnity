...
(() => {
  ...
  const cameraCompositionUrl = new URL('js/onboarding-character-creation-camera-composition.js?v=20260907charcreator10', selfUrl).href; // Sets the resting preview turn to 15° and lowers the camera eye line to Mao'ao male mid-body while preserving drag/face view.
