...
(() => {
  ...
  const reloadHandoffUrl = new URL('js/onboarding-character-creation-reload-handoff.js?v=20260915savev3a', selfUrl).href; // Commits the completed creator save durably, flushes the desktop folder when present, reloads once, then resumes the saved profile on a clean renderer session.
