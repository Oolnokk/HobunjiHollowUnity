...
(() => {
  ...
  const redesignUrl = new URL('js/onboarding-character-creation-redesign.js?v=20260907charcreator4', selfUrl).href; // Loads the integrated 3D preview, Slagothim/lore workflow, generated colors/outfits/dyes, runtime lighting, loading UI, and shell outline pass.
