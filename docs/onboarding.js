  ...
  const SPECIES_DATA = {
    ...
    'engh-sho': {
      ...
      male: {
        ...
        colorOptions: [
          { label: 'Snow',   h:   0, s: -0.95, v:  0.50 },
          { label: 'Frost',  h:  60, s: -0.90, v:  0.35 },
          { label: 'Ivory',  h: -40, s: -0.75, v:  0.45 },
          { label: 'Bone',   h: -50, s: -0.85, v:  0.20 },
          { label: 'Ash',    h:  10, s: -0.90, v:  0.10 },
          { label: 'Chalk',  h:   0, s: -0.95, v: -0.30 },
          { label: 'Rime',   h:  50, s: -0.92, v:  0.40 },
          { label: 'Tundra', h:  50, s: -0.85, v: -0.10 },
          { label: 'Stone',  h: -30, s: -0.85, v: -0.15 },
          { label: 'Dusk',   h: -80, s: -0.90, v: -0.35 },
          { label: 'Slate',  h:  70, s: -0.80, v: -0.25 },
          { label: 'Peat',   h: -70, s: -0.80, v: -0.55 },
        ],
      },
      female: {
    ...
    'mashtzarr': {
      ...
      male: {
        ...
        colorOptions: [
          ...
          { label: 'Khaki',     h:  -60, s: -0.20, v: -0.35 },
          { label: 'Olive',     h:  -40, s: -0.10, v: -0.30 },
          { label: 'Clay',      h: -100, s:  0.20, v: -0.25 },
          { label: 'Rust',      h: -143, s:  0.35, v: -0.20 },
          { label: 'Amber',     h: -113, s:  0.30, v: -0.15 },
          { label: 'Forest',    h:  -20, s:  0.10, v: -0.20 },
          { label: 'Teal',      h:   40, s:  0.45, v: -0.15 },
          { label: 'Slate',     h:   77, s: -0.40, v: -0.22 },
          { label: 'Onyx',      h:   0,  s: -0.50, v: -0.55 },
          { label: 'Bone',      h:  -50, s: -0.40, v:  0.20 },
          { label: 'Ochre',     h:  -83, s:  0.25, v: -0.10 },
        ],
      },
    },
  };
