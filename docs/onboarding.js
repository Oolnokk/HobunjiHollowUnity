...
(() => {
  ...
  const redesignUrl = new URL('js/onboarding-character-creation-redesign.js?v=20260907charcreator3', selfUrl).href; // Loads the integrated 3D preview, Slagothim workflow, lore, random colors, runtime lighting, loading UI, and shell outline pass.
