...
(() => {
  ...
  const cameraCompositionUrl = new URL('js/onboarding-character-creation-camera-composition.js?v=20260907charcreator11', selfUrl).href; // Presents the default character 15° off-center and moves the preview camera to a level Mao'ao-male mid-body eye line while keeping drag rotation and face-view anchoring correct.
