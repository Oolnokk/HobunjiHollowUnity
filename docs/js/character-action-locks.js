...
(() => {
  ...
  const prologueRescueZoneCompat = new URL('prologue-rescue-zone-compat.js?v=20260908a', base).href; // Waits until the authored rescue layout exists, then session-registers its id as a normal Cloud Forest EXTERIOR_ZONES entry so enterZone can actually load it.
