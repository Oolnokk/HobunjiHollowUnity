...
(() => {
  ...
  const livestockHarvestStaging = new URL('livestock-harvest-staging.js?v=20260918harvestanim1', base).href; // Loads exact multi-avatar harvest playback plus staging before FarmAnimals is assigned.
