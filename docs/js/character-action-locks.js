...
(() => {
  ...
  const social = new URL('social-action-wheel.js?v=20260909decouple1', base).href;
  ...
  const controllerSelectionUi = new URL('controller-selection-ui.js?v=20260909controller3', base).href; // Gives held controller wheel/arch openers automatic both-stick navigation with no authored mode shift.
