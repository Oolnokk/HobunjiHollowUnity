(() => {
  ...
  // The loading runtime goes first, then the travel-input bridge, then the
  // original WildernessMap module and its dependency-capture hook.
  if (document.readyState === 'loading') {
    document.write('<script src="js/loading-screen.js?v=20260824a"><\/script>');
    document.write('<script src="js/loading-screen-wilderness-bridge.js?v=20260824c"><\/script>');
  ...
  loadScript('js/loading-screen.js?v=20260824a')
    .then(() => loadScript('js/loading-screen-wilderness-bridge.js?v=20260824c'))
