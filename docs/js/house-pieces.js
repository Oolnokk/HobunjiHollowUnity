(() => {
  ...
  const scripts = [
    ...
    ['PorakanekiCampPlacementPolicy', 'porakaneki-camp-placement-policy.js?v=20260924chunkecology1'],
    ...
    ['PorakanekiCamps', 'porakaneki-camps-runtime.js?v=20260924chunkecology2'],
