(() => {
  ...
  const naturalSurfaceUvVersion = current?.src ? (new URL(current.src).searchParams.get('surfaceUv') || '20260925cavernshell1') : '20260925cavernshell1'; // Used by the natural rock/cliff UV stack below; decoupled from this bootstrap's own v= cache key so unrelated loader changes cannot invalidate the tightly-coupled surface generation.
  ...
  const scripts = [
    ...
    ['PorakanekiCamps', 'porakaneki-camps-runtime.js?v=20260925denturnover2'],
