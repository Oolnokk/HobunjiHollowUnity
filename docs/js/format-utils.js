(() => {
  ...
  (function loadTitleScreenRuntime() {
    ...
    const src = 'js/title-screen-runtime.js?v=20260917a'; // Cache-busts the title runtime after the lightweight real-time sky integration.
  ...
  (function loadStableAnimalFeatureBridge() {
    if (typeof document === 'undefined') return;
    const src = 'js/livestock-nursery-install-bridge.js?v=20260916stable5';
