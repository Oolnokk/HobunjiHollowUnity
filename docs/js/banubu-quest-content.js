...
(() => {
  ...
  const INTRO_SLEEP_2 = tree(
    ...
    [
      textNode('banubu_intro_sleep_2_line', 'Hmm? Let me rest my eyes for just a few more minutes.', null),
    ],
  ...
  const INTRO_TREE = tree(
    ...
    [
      ...
      textNode('banubu_intro_9', 'But if you want me to be any real help, it’s gotta be really nutritious. I haven’t eaten in so long, and it hasn’t been good for my health.', 'banubu_intro_10'),
      textNode('banubu_intro_10', 'I need a good Three-Fish Pie made that can give me {{banubuRequestedBuffs}}.', 'banubu_intro_11'),
  ...
  const Q1_READY = tree(
    ...
    [
      ...
      textNode('banubu_q1_ready_5', 'Ha! Look at that, the key to my Color Pools. I was wondering where that went. I was worried someone snatched it while I was asleep.', 'banubu_q1_ready_6'),
      textNode('banubu_q1_ready_6', 'Worst part is they wouldn’t have even known what the key was for. I’d be happy to have let them go in there and beautify their most beloved creatures.', 'banubu_q1_ready_7'),
      ...
      textNode('banubu_q1_ready_9', 'But after a hearty meal like that, I tend to get real tired and need to take a short nap. But that’s short by my standards, not yours as a little mortal.', 'banubu_q1_ready_10'),
