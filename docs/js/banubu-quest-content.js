...
(() => {
  ...
  const THREE_FISH_PIE_RECIPE = Object.freeze({
    ...
    label: 'Three-Fish Pie',
    icon: '🥧',
    desc: 'Banubu’s favorite pie: exactly three fish, carrying whatever cooking buffs those fish provide.',
    station: 'hearth',
    ...
    output: Object.freeze({
      icon: '🥧',
      label: 'Three-Fish Pie',
      tags: Object.freeze(['Cooked Food', 'Pie', 'Fish', 'Banubu']),
      baseSellPrice: 0,
      desc: 'A three-fish pie taught by Banubu.',
    }),
  });
  ...
  const NINE_LEAF_TEA_RECIPE = Object.freeze({
    ...
    label: 'Nine Leaf Tea',
    icon: '🍵',
    desc: 'Three Tea Blends—each ground from three herbs—finished with White Milk.',
    station: 'hearth',
    requiredCookingLevel: 0,
    lockedByDefault: true,
    slots: Object.freeze([
    ...
    output: Object.freeze({
      icon: '🍵',
      label: 'Nine Leaf Tea',
      tags: Object.freeze(['Cooked Food', 'Tea', 'Banubu']),
      baseSellPrice: 0,
      desc: 'A very strong bowl of tea made from nine herbs and White Milk.',
    }),
  });
  ...
  const Q1_OFFER = tree(
    ...
    ],
    {
      ...
      buffCount: 3,
      minStacks: 1,
      reward: { id: 'war_paint_kit', label: 'War-Paint Kit', scope: 'character', featureId: 'war_paint' },
    },
  );
  ...
  const STAGE_DEFAULTS = Object.freeze([
    Object.freeze({
      ...
      buffCount: 3,
      minStacks: 1,
      reward: Object.freeze({ id: 'war_paint_kit', label: 'War-Paint Kit', scope: 'character', featureId: 'war_paint' }),
    }),
    Object.freeze({
      stage: 2,
      questType: 'nineLeafTea',
