(() => {
  ...
  const GHOUL_BGM_TRACK = { url: 'assets/audio/music/bgm/bgm_just_beyond_the_torchlight.ogg', volumeMultiplier: 2, combatBgmExempt: true }; // Ghoul-floor music deliberately plays at twice the ordinary BGM base level and remains authoritative during combat.
