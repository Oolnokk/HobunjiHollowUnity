(() => {
  ...
  // access against the final V50 scene graph.
  if (document.readyState === 'loading') {
    document.write('<script src="js/dynamic-surfaces.js?v=20260913v50motion1"></scr' + 'ipt>');
    document.write('<script src="js/dev-random-ruin-hit-puzzles-loader.js?v=20260913v50motion1"></scr' + 'ipt>');
    document.write('<script src="js/dev-random-ruin-prototype-hooks.js?v=20260913v50motion1"></scr' + 'ipt>');
    document.write('<script src="js/dev-random-ruin-interior-map.js?v=20260913v50motion1"></scr' + 'ipt>');
    document.write('<script src="js/dev-random-ruin-motion-runtime.js?v=20260913v50motion1"></scr' + 'ipt>');
  }
})();
