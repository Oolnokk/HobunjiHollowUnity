(() => {
  ...
  async function _pixelProbeHandler(ev) {
    ...
    if (heldRenderDebug) lines.push(`Held x-ray: mode=${heldRenderDebug.mode} activeHeld=${heldRenderDebug.activeHeldMeshes ?? '-'}/${heldRenderDebug.heldMeshes} activeGround=${heldRenderDebug.activeGroundMeshes ?? '-'}/${heldRenderDebug.groundMeshes} activeWater=${heldRenderDebug.activeWaterReplayMeshes ?? '-'}/${heldRenderDebug.waterReplayMeshes ?? '-'} waterPasses=${heldRenderDebug.waterReplays ?? '-'} passes=${heldRenderDebug.baseWorldRenders}/${heldRenderDebug.selectiveOverlays}/${heldRenderDebug.nonGroundDepthReplays}/${heldRenderDebug.groundDepthRestores}`);
