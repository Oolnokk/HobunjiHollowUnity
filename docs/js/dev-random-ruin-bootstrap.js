...
(() => {
  ...
  document.write('<script src="js/dev-random-ruin-interior-map.js?v=20260926towerinput1"></scr' + 'ipt>');
  ...
  document.write('<script src="js/dev-random-ruin-interactions.js?v=20260926towerinput1"></scr' + 'ipt>');
