...
(() => {
  ...
  document.write('<script src="js/dev-random-ruin-interior-map.js?v=20260926simple1"></scr' + 'ipt>');
  document.write('<script src="js/dev-random-ruin-wall-planes.js?v=20260923review1"></scr' + 'ipt>');
  document.write('<script src="js/dev-random-ruin-wall-render-proxy.js?v=20260926unlit1"></scr' + 'ipt>');
  ...
  document.write('<script src="js/dev-random-ruin-simple-puzzles.js?v=20260926simple1"></scr' + 'ipt>');
  document.write('<script src="js/dev-random-ruin-interactions.js?v=20260926simplehold1"></scr' + 'ipt>');
