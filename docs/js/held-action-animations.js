...
(() => {
  ...
  const handScripts = [
    ...
    new URL('js/procedural-hand-skinned-outline.js?v=20260819b', docsBase).href,
  ...
  if (isAttackEditor) {
    ...
    handScripts.push(new URL('js/hand-pixel-probe-diagnostics.js?v=20260819b', docsBase).href);
  }
