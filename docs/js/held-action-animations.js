...
(() => {
  ...
  const handScripts = [
    ...
    new URL('js/hand-shoulder-pose-runtime.js?v=20260920elbow3', docsBase).href,
    ...
    new URL('js/procedural-hand-shoulder-aim.js?v=20260920elbow3', docsBase).href,
  ...
  if (isAttackEditor) {
    ...
    handScripts.push(new URL('js/attack-editor-hand-shoulder-controls.js?v=20260920elbow3', docsBase).href);
    handScripts.push(new URL('js/attack-editor-idle-hand-parity.js?v=20260920localhinge1', docsBase).href);
    handScripts.push(new URL('js/attack-editor-hand-shoulder-animation-state.js?v=20260920elbow3', docsBase).href);
