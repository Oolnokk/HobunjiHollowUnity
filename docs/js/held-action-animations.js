...
(() => {
  ...
  const handScripts = [
    ...
    new URL('js/hand-tool-grips.js?v=20260917charge1', docsBase).href,
    new URL('js/hand-grip-modes.js?v=20260818c', docsBase).href,
    new URL('js/hand-shoulder-pose-runtime.js?v=20260917charge1', docsBase).href,
    ...
    new URL('js/procedural-hand-frame-driver.js?v=20260916perf1', docsBase).href,
  ];
  if (isAttackEditor) {
