...
(() => {
  ...
  const handScripts = [
    ...
    new URL('js/hand-tool-semantic-basis.js?v=20260819c', docsBase).href,
    ...
    new URL('js/procedural-hand-attachments.js?v=20260819a', docsBase).href,
  ...
  if (isAttackEditor) {
    ...
    handScripts.push(new URL('js/attack-editor-hand-tool-closeup.js?v=20260819e', docsBase).href);
    handScripts.push(new URL('js/attack-editor-hand-tool-basis-author.js?v=20260819c', docsBase).href);
  } else {
    ...
    handScripts.push(new URL('js/hand-pixel-probe-diagnostics.js?v=20260819e', docsBase).href);
  }
