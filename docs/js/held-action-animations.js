...
(() => {
  ...
  const handScripts = [
    ...
    new URL('js/hand-tool-grips.js?v=20260902a', docsBase).href,
  ...
  if (isAttackEditor) {
    ...
    handScripts.push(new URL('js/attack-editor-hand-direct-attachments.js?v=20260902a', docsBase).href);
    ...
    handScripts.push(new URL('js/weapon-png-scale.js?v=20260902a', docsBase).href);
