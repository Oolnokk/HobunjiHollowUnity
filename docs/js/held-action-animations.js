...
(() => {
  ...
  const handScripts = [
    ...
    new URL('js/procedural-hand-shoulder-aim.js?v=20260920poseelbow1', docsBase).href,
  ...
  if (isAttackEditor) {
    ...
    handScripts.push(new URL('js/attack-editor-hand-shoulder-controls.js?v=20260920poseelbow1', docsBase).href);
