(() => {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      .cp-body{display:grid;grid-template-columns:minmax(260px,340px) 1fr;gap:12px;padding:12px}.cp-card{border:1px solid rgba(255,255,255,.11);background:rgba(255,255,255,.035);border-radius:12px;padding:10px;margin-bottom:9px}
      ...
      .cp-preview{display:grid;place-items:center;min-height:260px;background:#090d0f;border:1px solid rgba(255,255,255,.1);border-radius:12px;background-image:linear-gradient(45deg,rgba(255,255,255,.04) 25%,transparent 25%),linear-gradient(-45deg,rgba(255,255,255,.04) 25%,transparent 25%),linear-gradient(45deg,transparent 75%,rgba(255,255,255,.04) 75%),linear-gradient(-45deg,transparent 75%,rgba(255,255,255,.04) 75%);background-size:18px 18px;background-position:0 0,0 9px,9px -9px,-9px 0}
      .cp-preview canvas{width:min(360px,100%);height:auto;image-rendering:pixelated}.cp-region{border-top:1px solid rgba(255,255,255,.09);padding-top:9px;margin-top:9px}.cp-region:first-child{border-top:0;margin-top:0;padding-top:0}
