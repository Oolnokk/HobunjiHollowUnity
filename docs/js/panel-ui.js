...
(() => {
  ...
  const core = new URL('./panel-ui-core.js?v=20260914terrain1', src).href; // Used as the unchanged historical PanelUI implementation expected synchronously by existing tools.
  const terrainParity = new URL('./tool-terrain-preview-parity.js?v=20260914terrain1', src).href; // Used to install shared game-material/UV parity and native-scale controls in terrain tools.
