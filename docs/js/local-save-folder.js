...
document.write('<script src="js/folder-save-debug-ui.js?v=20260915drivee"><\/script>');
document.write('<script src="js/google-drive-save-ui.js?v=20260915a"><\/script>');
document.write('<script src="js/google-drive-save-startup.js?v=20260915b"><\/script>');
document.write('<script src="js/google-drive-save-legacy-cloud-bridge.js?v=20260915a"><\/script>');
