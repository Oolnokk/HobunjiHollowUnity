...
document.write('<script src="js/folder-save-transaction-journal.js?v=20260915a"><\/script>');
document.write('<script src="js/local-save-folder-core.js?v=20260915c"><\/script>');
