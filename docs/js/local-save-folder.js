...
document.write('<script src="js/folder-save-debug-ui.js?v=20260915drivef"><\/script>');
...
document.write('<script src="js/google-drive-save-legacy-cloud-bridge.js?v=20260915b"><\/script>');
