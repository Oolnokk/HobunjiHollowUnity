...
document.write('<script src="js/local-save-folder-core.js?v=20260925savecorrupt7"><\/script>');
...
document.write('<script src="js/save-checkpoint-manager.js?v=20260925savecorrupt7"><\/script>');
