...
document.write('<script src="js/local-save-folder-core.js?v=20260925savecorrupt3"><\/script>');
document.write('<script src="js/folder-save-primary.js?v=20260925savecorrupt3"><\/script>');
...
document.write('<script src="js/save-checkpoint-manager.js?v=20260925savecorrupt4"><\/script>');
document.write('<script src="js/folder-save-quit-guard.js?v=20260916menu3"><\/script>');
document.write('<script src="js/folder-save-debug-ui.js?v=20260925savecorrupt3"><\/script>');
