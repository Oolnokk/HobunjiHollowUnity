(() => {
  ...
  const featureScripts = [ // Used to load each modular feature's config before its runtime implementation.
    ...
    { globalKey: 'StableAnimalProgression', src: 'js/stable-animal-progression.js?v=20260922greetingserialize1' },
    { globalKey: 'StableAnimalPerkAdjustments', src: 'js/stable-animal-perk-adjustments.js?v=20260922greetingserialize1' },
