...
(() => {
  ...
  const modules = [
    ...
    ['js/combat/ranged-weapon-archetypes.js?v=20260917npcthrow1', () => Number(window.HobunjiRangedWeaponArchetypes?.version) >= 3],
    ['js/combat/porakaneki-dagger-ranged.js?v=20260917dagger2', () => Number(window.HobunjiPorakanekiDaggerRanged?.version) >= 2],
