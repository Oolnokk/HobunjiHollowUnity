...
(() => {
  ...
  const modules = [
    ...
    ['js/npc-furniture-wardrobe-bridge.js?v=20260904a', () => !!window.NpcFurnitureWardrobes],
    ['js/npc-social-relationship-bridge.js?v=20260903rapport1', () => !!window.NpcRapport],
    ...
    ['js/prone-motion-exclusivity.js?v=20260812a', () => !!window.HobunjiDrunkProneCompositionBridge],
