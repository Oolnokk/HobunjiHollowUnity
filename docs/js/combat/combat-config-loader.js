...
(() => {
  ...
  const modules = [
    ...
    ['js/clothing-weaving-system.js?v=20260920animal-scale-outline1', () => Number(window.ClothingWeavingSystem?.version) >= 1],
    ...
    ['js/combat/ranged-weapon-archetypes.js?v=20260918throwframe1', () => Number(window.HobunjiRangedWeaponArchetypes?.version) >= 9],
