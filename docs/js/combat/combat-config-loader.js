...
(() => {
  ...
  const modules = [
    ...
    ['js/footing-damage-recovery-bridge.js?v=20260819a', () => !!window.HobunjiFootingDamageRecovery],
    ['js/combat/footing-knockdown.js?v=20260819a', () => !!window.HobunjiFootingKnockdown],
