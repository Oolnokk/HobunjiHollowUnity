...
(() => {
  ...
  const modules = [
    ...
    ['js/clothing-weaving-system.js?v=20260918colorswap1', () => Number(window.ClothingWeavingSystem?.version) >= 1],
    ...
    ['js/combat/ranged-weapon-archetypes.js?v=20260920projectileport1-arcembed1-spearspin2', () => Number(window.HobunjiRangedWeaponArchetypes?.version) >= 13],
    ...
    ['js/combat/enemy-combat-health-recovery.js?v=20260914a', () => Number(window.EnemyCombatHealthRecoveryPolicy?.version) >= 1],
