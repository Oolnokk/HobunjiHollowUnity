...
(() => {
  ...
  const modules = [
    ...
    ['js/combat/ranged-camera-focus.js?v=20260906c', () => Number(window.HobunjiRangedCameraFocus?.version) >= 3],
    ['js/combat/attack-camera-player-root.js?v=20260906a', () => Number(window.HobunjiAttackCameraPlayerRoot?.version) >= 1],
