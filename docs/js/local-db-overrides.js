...
(() => {
  ...
  function _installNamedAnimalNpcModule() {
    ...
    const moduleUrl = new URL('named-animal-npc.js?v=20260923review1', LOCAL_DB_SCRIPT_URL).href; // Shared bridge URL resolved next to local-db-overrides.js in docs/js/; explicit version prevents a stale 200px world-animal bridge after deploy.
