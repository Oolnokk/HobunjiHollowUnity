...
(function (global) {
  ...
  function buildGroup(THREE, minC, maxC, minR, maxR, opts) {
    ...
    if (opts.wallBuilder) {
      ...
      var gableExtra = opts.wbGableOpts || Object.assign({}, wbExtra, { unitMult: 0.66, rockScale: 1.1 });
  ...
  function buildGroupFromPiece(THREE, piece, bldgMinC, bldgMinR, opts) {
    ...
    if (opts.wallBuilder) {
      ...
      if (gablePanels.length) {
        var gblExtra = opts.wbGableOpts || Object.assign({}, wbExtra, { unitMult: 0.66, rockScale: 1.1 });
