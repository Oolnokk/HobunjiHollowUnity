...
function wire(){
  ...
  $('addTreeBtn').onclick=()=>addTree();$('treeEditorBtn').onclick=openTreeEditor;$('deleteTreeBtn').onclick=()=>deleteTree();$('addTextBtn').onclick=()=>addNode('text');$('addVisualBtn').onclick=()=>addNode('visual');$('addChoiceBtn').onclick=()=>addNode('choice');$('addAccessShopBtn').onclick=()=>addNode('accessShop');$('addEndBtn').onclick=()=>addNode('end');$('addSequenceBtn').onclick=()=>addNode('sequence');$('deleteNodeBtn').onclick=()=>deleteNode();$('setEntryBtn').onclick=()=>setEntryNode();
